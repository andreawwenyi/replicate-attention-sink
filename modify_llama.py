...
original modify_llama.py from the attention sink github repo: https://github.com/mit-han-lab/streaming-llm/blob/main/streaming_llm/pos_shift/modify_llama.py
"""
import math
...
def llama_pos_shift_attention_forward(
    ...
    if past_key_value is not None:
        ...
        # print("shape of key_states: ", key_states.shape) # [1, 32, seq_len, 128]
